...
public class LogRepositoryConstants {
    ...
    public static final String AVG_EXEC_PLUS_FETCH_TIME_COLUMN = "AVG_EXEC_PLUS_FETCH_TIME";
    ...
    public static final String MAX_EXEC_PLUS_FETCH_TIME_COLUMN = "MAX_EXEC_PLUS_FETCH_TIME";
    public static final String MIN_EXEC_PLUS_FETCH_TIME_COLUMN = "MIN_EXEC_PLUS_FETCH_TIME";
    ...
    public static final String TOTAL_EXEC_PLUS_FETCH_TIME_COLUMN = "TOTAL_EXEC_PLUS_FETCH_TIME";
